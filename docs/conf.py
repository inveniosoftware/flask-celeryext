# -*- coding: utf-8 -*-
#
# Flask-CeleryExt documentation build configuration file, created by
...
htmlhelp_basename = 'Flask-CeleryExtdoc'
...
texinfo_documents = [
  (master_doc, 'Flask-CeleryExt', u'Flask-CeleryExt Documentation',
   author, 'Flask-CeleryExt', 'One line description of project.',
   'Miscellaneous'),
]
